...
void Visualisation::showNewCones(const std::vector<std::unique_ptr<Cone>> &coneList)
{
	...
	for (const std::unique_ptr<Cone>& cone : coneList)
	{
		...
		new_cone_markers.markers[i].mesh_resource = "package://bound_est/src/resources/meshes/cone.dae";
...
void Visualisation::showFramedCones(const std::vector<std::unique_ptr<Cone>> &coneList)
{
	...
	for (const std::unique_ptr<Cone>& cone : coneList)
	{
		...
		framed_cone_markers.markers[i].mesh_resource = "package://bound_est/src/resources/meshes/cone.dae";
...
void Visualisation::showOldCones(const std::vector<std::unique_ptr<Cone>> &coneList)
{
	...
	for (const std::unique_ptr<Cone>& cone : coneList)
	{
		...
		old_cone_markers.markers[i].mesh_resource = "package://bound_est/src/resources/meshes/cone.dae";
...
void Visualisation::showCar(const Pos &pos)
{
	...
	car_marker.mesh_resource = "package://bound_est/src/resources/meshes/eclipse.stl";
